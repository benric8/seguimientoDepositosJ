...
public class MovDepositoJudicial implements Serializable {
	...
	public static final String DJ_EXPEDIENTE="numeroExpediente";
    ...
    @OneToMany(mappedBy = "movDepositoJudicial")
